...
XMODEM_DATA_SIZE	EQU		128
	...
	SHLLI	r2,r2,16
	ORI		r2,r2,low(SEND_BYTE)			;SEND_BYTE to r2

	ORI		r0,r3,high(RECV_BYTE)
	SHLLI	r3,r3,16
	ORI		r3,r3,low(RECV_BYTE)			;RECV_BYTE to r3

	ORI 	r0,r4,high(WAIT_PUSH_SW)
	SHLLI	r4,r4,16
	ORI		r4,r4,low(WAIT_PUSH_SW)		;WAIT_PUSH_SW to r4
...
;;; UART
	...
	ORI		r0,r21,0x2								;�o�̓f�[�^������16�r�b�g��r21�ɃZ�b�g
	SHLLI	r21,r21,16								;16�r�b�g���V�t�g
	ORI		r21,r21,0xFFFF						;�o�̓f�[�^������16�r�b�g��r21�ɃZ�b�g
...
_WAIT_PUSH_SW_ON:
	...
	BNE		r0,r17,_WAIT_PUSH_SW_ON
	ANDR	r0,r0,r0					;NOP
_WAIT_PUSH_SW_OFF:
	LDW		r16,r17,GPIO_IN_OFFSET
	BE		r0,r17,_WAIT_PUSH_SW_OFF
	ANDR	r0,r0,r0					;NOP
